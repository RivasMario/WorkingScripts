...
Function DisplayHud() {
    ...
    "{0,-23}  {1,-6}  {2,-10} {3,8} {4,5}" -f ("Operator", "Date", "Start", "End", "SOC")
    "{0,-23}  {1,-6}  {2,-10} {3,8} {4,5}" -f ("--------", "------", "--------", "------", "-----")        
	
	#$shifts = Import-Excel C:\Users\v-anjasp\Documents\soc.xlsx
    #$shifts[2].Operator
    #$shifts[2].Start
    #$shifts[2].End
    #$shifts[2].date
...
$Header = @"
<meta http-equiv="refresh" content="5; url=PSDrives.html" />
"@
.\OnShift_2.1.7_test.ps1 | ConvertTo-Html -Property Name,Used,Provider,Root,CurrentLocation -Head $Header > C:\TriageLoopers\PSDrives.html
